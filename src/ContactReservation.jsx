...
const ContactReservation = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            setMessage('Reservation request submitted! We will confirm via email shortly.');
        ...
        <section id="reservations" className="py-20 bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-xl text-gray-400 text-center mb-12 max-w-3xl mx-auto">
                    Secure a table for an unforgettable evening. We look forward to hosting you.
                </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 bg-gray-800 p-8 rounded-xl shadow-xl border border-yellow-800/30">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {message && (
                                <p className={`mt-4 text-center p-3 rounded-lg font-medium ${message.includes('success') ? 'bg-green-600/30 text-green-300' : 'bg-red-600/30 text-red-300'}`}>
                                    {message}
                                </p>
                            )}
                        </form>
                        ...
                        <div className="bg-gray-800 p-8 rounded-xl shadow-xl border border-yellow-800/30">
                            ...
                            <ul className="space-y-2 text-gray-300">
                                {RestaurantData.hours.map((item) => (
                                    <li key={item.day} className="flex justify-between border-b border-gray-700 pb-2 last:border-b-0">
                                        <span className='font-medium'>{item.day}:</span>
                                        <span className={item.time === 'Closed' ? 'text-red-400 font-bold' : 'text-yellow-300'}>
                                            {item.time}
                                        </span>
                                    </li>
                                ))}
